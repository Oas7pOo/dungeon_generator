...
def test_two_layer_buildings():
    ...
    # 1. 为第一层生成100个1层建筑区
    print("\n1. 为第一层生成100个1层建筑区...")
    layer1_gen = RectangleBuildingAreaGenerator("第一层建筑区", map_name=map_name, layer=1, db_manager=db_manager)
    ...
    print("\n2. 为第二层生成100个1层建筑区...")
    layer2_gen = RectangleBuildingAreaGenerator("第二层建筑区", map_name=map_name, layer=2, db_manager=db_manager)
